...
**Поиск пользователей ничего не находит**

- В Supabase **SQL Editor** выполните полный **`supabase/schema.sql`** (или только блок с функцией `search_profiles` в конце файла). Без этой функции поиск может не работать или работать нестабильно.
